...
namespace TeamCommandCenter.Utils
{
    using System;
    using System.IO;
    ...
    public static class Decryptor
    {
        ...
        public static string Decrypt(string encryptedPayload, string encryptedSymmetricKey, string signature, Models.AzureADSettings settings)
        {
            ...
            // The certificate and private key should come from KeyVault in a production scenario
            using X509Certificate2 certificate = new X509Certificate2(Convert.FromBase64String(settings.Cert), settings.Cert);
